			...
			<div className='font-poppins'>
				<div className='flex items-end'>
					<div className='py-6 gap-3 px-3 items-center md:items-start flex flex-col'>
						...
						<h1 className='capitalize font-bold lg:min-w-[380px] md:text-[42px] mt-7'>
							Hungry for More?
						</h1>
						<h2 className='capitalize font-semibold text-gray-700 md:text-4xl'>
							Sign up now!
						</h2>
						...
						<div>
							<div className='flex items-center md:items-start gap-4 mt-10 flex-col'>
								<ButtonNextUI
									...
									type='button'
									variant='bg-transparent min-w-[330px] border border-black'
								...
								<ButtonNextUI
									...
									type='button'
									variant='bg-black min-w-[330px]'
								/>
								<p className='text-sm max-w-[350px]  lg: mb-10'>
